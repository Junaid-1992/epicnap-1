                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: Text(
                            'Sleep quality',
                            // controller.dashboardScreenController.sleepquality.value.toString(),
                      ...
                      lineBarsData: [
                        LineChartBarData(
                          ...
                          spots: [
                            ...
                            FlSpot(3, controller.notificationScreenController.selectedStars.value == 0
                                ?controller.dashboardScreenController.sleepquality.value.toDouble()
                                :controller.notificationScreenController.selectedStars.value.toDouble()),
                            FlSpot(4, 0),
                            FlSpot(5, 0),
                        ...
                        LineChartBarData(
                          spots: [
                            ...
                            FlSpot(3, controller.notificationScreenController.selectedIndex.value == -1
                                ?controller.dashboardScreenController.sleepmood.value.toDouble()
                                :controller.notificationScreenController.selectedIndex.value.toDouble() +1
                            ),
