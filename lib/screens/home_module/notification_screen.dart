          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Obx(() => TextFormField(
                  controller: TextEditingController(text: controller.bedTimes.value),
                  ...
                  readOnly: true,
                  onTap: () {
                    controller.selectBedTime(context);
                  },
                )),
                ...
                Obx(() => TextFormField(
                  controller: TextEditingController(text: controller.wakeTimes.value),
                  decoration: InputDecoration(
                  ...
                  readOnly: true,
                  onTap: () {
                    controller.selectWakeTime(context);
                  },
                )),
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Row(
                  ...
                  children: [
                    Container(
                      width: 300,
                      child: Text(
                        'Please fill in this questionnaire each week to evaluate your mental well-being. For each statement, rate your response on a scale of 1 to 5, where 1 indicates "none of the time," 2 means "rarely," 3 stands for "some of the time," 4 signifies "often," and 5 represents "all of the time”.',
                        textAlign: TextAlign.center,
                        style: TextStyle(
                          fontSize: 14,
                          fontWeight: FontWeight.bold,
                ...
                //       spacing: 30.0, // Adjust spacing between buttons
                //       runSpacing: 30.0, // Adjust spacing between rows
                //       children: List.generate(5, (index) {
                //         return GestureDetector(
                //           onTap: () {
                //             controller.setNumber(index + 1);  // Index starts from 0, so add 1 to get the actual rating value
                ...
                //             children: [
                //               Text(
                //                 controller.titles[index],  // Get the title for the current index
                //                 style: TextStyle(
                //                   fontSize: 14,
                //                   fontWeight: FontWeight.bold,
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: controller.selectedNumber.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber2.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber2.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber3.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber3.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber4.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber4.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber5.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber5.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //     padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //     decoration: BoxDecoration(
                //     color: controller.selectedNumber6.value == index + 1
                //     ? Color(0xFF281f57)
                //         : Colors.grey,
                //     borderRadius: BorderRadius.circular(5.0),
                //     ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber6.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
                ...
                //                 padding: EdgeInsets.only(left: 8, right: 8, top: 3, bottom: 3),
                //                 decoration: BoxDecoration(
                //                   color: controller.selectedNumber7.value == index + 1
                //                       ? Color(0xFF281f57)
                //                       : Colors.grey,
                //                   borderRadius: BorderRadius.circular(5.0),
                //                 ),
                  ...
                  children: List.generate(5, (index) {
                    return GestureDetector(
                      ...
                      child: Container(
                        ...
                        padding: EdgeInsets.only(left:16, right:16 , top: 12, bottom: 12),
                        decoration: BoxDecoration(
                          color: controller.selectedNumber7.value == index + 1 ? Color(0xFF281f57) : Colors.transparent,
                          borderRadius: BorderRadius.circular(12.0),
                          border: Border.all(
                            color:
                            Colors.white  // Border color for selected state
